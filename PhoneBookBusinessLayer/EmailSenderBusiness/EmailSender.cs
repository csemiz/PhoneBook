    ...
    public class EmailSender : IEmailSender
    {
        ...
        private void MailInfoSet(EmailMessage message, out MailMessage mail, out SmtpClient client)
        {
            try
            {
                ...
                {
                    From=new MailAddress(SenderMail)//sinifin/projenin emaili
                };
                ...
                {
                    EnableSsl = true,
                    Credentials=new NetworkCredential(SenderMail,Password)//emaile girebilmek icin kullanici adi ve parolasi gerekli
                };
            }
            catch (Exception)
            {
